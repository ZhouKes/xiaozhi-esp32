 ...
 */
typedef struct {
    const gc9b71_lcd_init_cmd_t *init_cmds;    /*!< Pointer to initialization commands array.
...
} gc9b71_vendor_config_t;

/**
 * @brief Create LCD panel for model GC9B71
 *
 ...
 *
 */
#define GC9B71_PANEL_BUS_SPI_CONFIG(sclk, mosi, max_trans_sz)   \
    {                                                           \
        .sclk_io_num = sclk,                                    \
        .mosi_io_num = mosi,                                    \
        .miso_io_num = -1,                                      \
...
#define GC9B71_PANEL_BUS_QSPI_CONFIG(sclk, d0, d1, d2, d3, max_trans_sz) \
    {                                                           \
        .data0_io_num = d0,                                     \
        .data1_io_num = d1,                                     \
        .sclk_io_num = sclk,                                    \
 ...
 *
 */
#define GC9B71_PANEL_IO_SPI_CONFIG(cs, dc, cb, cb_ctx)          \
    {                                                           \
        .cs_gpio_num = cs,                                      \
        .dc_gpio_num = dc,                                      \
        .spi_mode = 0,                                          \
...
#define GC9B71_PANEL_IO_QSPI_CONFIG(cs, cb, cb_ctx)             \
    {                                                           \
        .cs_gpio_num = cs,                                      \
        .dc_gpio_num = -1,                                      \
        .spi_mode = 0,                                          \
